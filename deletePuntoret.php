...
<head>
    ...
    <p style="color:white"> RESTAURANT BAR & FOOD DELIVERY </p></a>
      ...
      <div class="container">
          <div class="row">
      		<div class="col-12"><br />
      <center>  <h1 style="color:black">Delete Punetoret</h1></center><br>
      </div>
        		<div class="col-12">
              <center><button style="background:navy;color:white;border:none" onClick="location.href='registerPuntoret.php'"type="button" class="btn btn-default">Register</button>
        <button style="background:red;color:white;border:none" onClick="location.href='updatePuntoret.php'"type="button" class="btn btn-default">Update</button></center><br>
       </div>
                    <br><br>
           <div style="color:black">

          <?php
          include "Includes/functions/selectDeletePuntor.php";?>
