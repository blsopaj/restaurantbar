        ...
        <nav class="nav-part"> <!-- pjesa e navigimit -->
            ...
            <div class="mobile-menu">
                ...
                <div class="line3"></div>
					...
					$id = $emri = $pershkrimi = $cmimi =  "";

					//kushti if ne kete rast do te plotesohet vetem pasi klikohet butoni Submit ne formen
					if($_SERVER['REQUEST_METHOD'] == 'POST') {

						include 'includes/functions/ushqimiReg.php';
					}
					?>
    <form  action = "<?php echo $_SERVER['PHP_SELF'];?>" method = "POST">
    <h1 class="text-center" style="color:black">Regjistrimi i Ushqimeve</h1><br>
    <div class="container">
         <div class="row">
            <div class="col-12">
                <center><button style="background:navy;color:white;border:none" onClick="location.href='updateUshqimi.php'"type="button" class="btn btn-default">Update</button>
            ...
            <div class="col-12">
                <center><input type="text" class="form-control" name="id" placeholder="Id" style="width:270px"></center>
            ...
            <div class="col-12">
				<center><input type="text" class="form-control" placeholder="Kodi" name="kodi" style="width:270px"></center><br>
            </div>  
            <div class="col-12">
             ...
             <div class="col-12">
				<center><input type="number" class="form-control" placeholder="Sasia" name="sasia" style="width:270px"></center><br>
             </div>   
             <div class="col-12">
				<center><input type="text" class="form-control" placeholder="Kategoria" name="kategoria" style="width:270px"></center><br>
             </div>     
             <div class="col-12">
                 <center>
                 <input type="file" id="myfile" name="fotografia"> 
                 </center><br>
             </div>
             <div class="col-12">
