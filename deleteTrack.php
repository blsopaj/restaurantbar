...
<head>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12"><br />
                <center><h1 style="color:black">Delete Track</h1></center><br>
            </div>
            <div class="col-12">
            <center>
                <button style="background:navy;color:white;border:none" onClick="location.href='insertTrack.php'"type="button" class="btn btn-default">Insert</button>
                 <button style="background:red;color:white;border:none" onClick="location.href='updateTrack.php'"type="button" class="btn btn-default">Update</button>
            </center>
            <br><br>
            </div>  
        </div>
    ...
    <div style="color:black">
      <?php include "Includes/functions/selectDeleteTrack.php";?>
    </div>
    <br/><br/>
